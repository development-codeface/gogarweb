...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__category_model__ = __webpack_require__("../../../../../src/app/pages/category/category.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__category_service__ = __webpack_require__("../../../../../src/app/pages/category/category.service.ts");
...
var CategoryComponent = /** @class */ (function () {
    function CategoryComponent(fb, router, toastrService, membershipService, menuService, _location, modalService, http, HttpClient) {
        this.fb = fb;
        this.router = router;
    ...
    CategoryComponent.prototype.fileOverBase = function (e) {
        this.hasBaseDropZoneOver = e;
    };
    CategoryComponent.prototype.fileOverAnother = function (e) {
    ...
    CategoryComponent.prototype.uploadFiles = function (files, images) {
        console.log(images.join());
    };
    CategoryComponent.prototype.goviewpage = function (Item) {
        console.log(Item);
        this.router.navigate(['/pages/subcategory'], { queryParams: { users: JSON.stringify(Item) } });
    };
    CategoryComponent.prototype.getDate = function () {
        console.log(this.files);
        return new Date();
    };
    CategoryComponent.prototype.onSelectFile = function (event) {
        var _this = this;
        console.log(event);
    ...
    CategoryComponent.prototype.getItems = function (ev) {
        console.log(ev);
    ...
    CategoryComponent.prototype.removeimage = function (i) {
        this.urls.splice(i, 1);
    };
    CategoryComponent.prototype.onUpload = function () {
    ...
    CategoryComponent.prototype.getUsers = function () {
        var _this = this;
        this.membershipService.getUsers().then(function (users) {
            _this.userdatafull = users;
            _this.users = _this.userdatafull.details;
            console.log(_this.users);
        });
    };
    CategoryComponent.prototype.getproductcategory = function () {
        var _this = this;
    ...
    CategoryComponent.prototype.addUser = function (user) {
        var _this = this;
    ...
    CategoryComponent.prototype.addcat = function (cat) {
        var _this = this;
    ...
    CategoryComponent.prototype.updatecat = function (user, userimages) {
        var _this = this;
        console.log(this.files);
    ...
    CategoryComponent.prototype.updateUser = function (user, userimages) {
        var _this = this;
        console.log(this.files);
        if (this.files.length != 0) {
            this.membershipService.uploadimage(this.sendableFormData).subscribe(function (result) {
    ...
    CategoryComponent.prototype.deleteUser = function (user) {
        var _this = this;
        this.membershipService.deleteUser(user.id).subscribe(function (result) {
            return _this.getUsers();
        });
    };
    CategoryComponent.prototype.deletecat = function (cat) {
        var _this = this;
        this.membershipService.deletecat(cat.Id).subscribe(function (result) {
            return _this.getUsers();
        });
    };
    CategoryComponent.prototype.toggle = function (type) {
        this.type = type;
    };
    CategoryComponent.prototype.openMenuAssign = function (event) {
    ...
    CategoryComponent.prototype.closeMenuAssign = function (event) {
        var parent = event.target.parentNode;
        while (parent) {
            parent = parent.parentNode;
            if (parent.classList.contains('content')) {
    ...
    CategoryComponent.prototype.assignMenuItemsToUser = function (user) {
    ...
    CategoryComponent.prototype.openModal = function (modalContent, user) {
        var _this = this;
        console.log(user);
        if (user) {
            this.user = user;
            ...
            this.user = new __WEBPACK_IMPORTED_MODULE_5__category_model__["b" /* User */]();
            console.log(this.user);
            this.user.settings = new __WEBPACK_IMPORTED_MODULE_5__category_model__["c" /* UserSettings */]();
        }
    ...
    CategoryComponent.prototype.openModal1 = function (modalContent, user) {
        var _this = this;
        console.log(user);
        if (user) {
            this.cat = user;
            ...
            this.cat = new __WEBPACK_IMPORTED_MODULE_5__category_model__["a" /* Getproductcategory */]();
    ...
    CategoryComponent.prototype.closeModal = function () {
        this.modalRef.close();
    };
    CategoryComponent.prototype.onSubmit = function (user) {
        if (this.form.valid) {
            if (user.id) {
    ...
    CategoryComponent.prototype.onSubmit1 = function (cat) {
    ...
    CategoryComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_6__category_service__["a" /* CategoryService */], __WEBPACK_IMPORTED_MODULE_7__theme_components_menu_menu_service__["a" /* MenuService */]]
        }),
...
/***/ "../../../../../src/app/pages/category/category.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__category_component__ = __webpack_require__("../../../../../src/app/pages/category/category.component.ts");
...
var routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_8__category_component__["a" /* CategoryComponent */], pathMatch: 'full' }
];
var CategoryModule = /** @class */ (function () {
    ...
    CategoryModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_8__category_component__["a" /* CategoryComponent */]
            ]
        })
    ], CategoryModule);
...
/***/ "../../../../../src/app/pages/category/category.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.getUsers = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get(_this.url + 'Getproductcategory')
    ...
    CategoryService.prototype.getproductcat = function () {
        return this.http.get(this.url + 'Getproductcategory');
    };
    CategoryService.prototype.addUser = function (user) {
        var _this = this;
        console.log(user);
        return new Promise(function (resolve, reject) {
    ...
    CategoryService.prototype.updateUser = function (user) {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    CategoryService.prototype.updatecat = function (user) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.post(_this.url + 'Editproductcategory', JSON.stringify(user))
                .subscribe(function (val) {
                console.log("POST call successful value returned in body", val);
                resolve(val);
            }, function (response) {
    ...
    CategoryService.prototype.deleteUser = function (id) {
    ...
    CategoryService.prototype.uploadimage = function (val) {
        console.log(val);
        return this.http.post("http://codefacetech.com/demo/gogars/Apis/upload.php", val, {
            reportProgress: true //, responseType: 'text'
        });
    };
    CategoryService.prototype.onUpload = function (files) {
    ...
    CategoryService.prototype.query = function (params) {
        var _this = this;
